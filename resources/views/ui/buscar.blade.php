...
<form action=" {{route('vacantes.buscar')}}" method="POST">
    ...
    <div class="mb-5">
        <label for="categoria" class="block text-gray-700 text-sm mb-2">Carrera:</label>
    ...
    <button type="submit" class="bg-green-500 w-full hover:bg-green-600 text-white font-bold p-3
    focus:outline-none focus:shadow-outline uppercase mt-10">Buscar Vacantes</button>
</form>
