        ...
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border border-2 shadow-md ">
                ...
                <form class="py-10 px-5" method="POST" action="{{ route('login') }}" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        <input class="mr-2 mt-1" type="checkbox" name="remember" id="remember"
                    ...
                    <div class="flex flex-wrap">
                            ...
                            <button
                            type="submit"
                            class="bg-green-500 w-full hover:bg-green-700
                            ...
                            <a class="text-sm text-gray-600 mt-5 text-center w-full" href="{{ route('password.request') }}">
