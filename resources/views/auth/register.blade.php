...
<div class="container mx-auto max-w-screen-md">
    <div class="flex flex-wrap justify-center">
        <div class="md:w-1/2 order-2 md:order-1">
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-words bg-white border border-2 shadow-md mt-5">
                    ...
                    <form class="pt-10 px-5 pb-5" method="POST" action="{{ route('register') }}" novalidate>
                        @csrf
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password" type="password"
                                class="p-3 bg-gray-300 rounded form-input w-full @error('password') is-invalid @enderror" name="password"
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password-confirm" type="password" class="p-3 bg-gray-300 rounded form-input w-full"
        ...
        <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10 mt-10">
            <h2 class="text-green-500 text-3xl font-bold">¿Eres Reclutador?</h2>

            <p class="text-xl mt leading-7">Crea una Cuenta totalmente gratis y comienza a publicar tus vacantes</p>
